        ...
        <div class="row">
            <div class="col">
                <div class="d-flex align-items-center">
                    <span 
                        class="btn btn-lg rounded-circle text-white mr-2" 
                ...
                <div class="d-flex align-items-center justify-content-between mt-3">
                    ...
                    <div>
                        ...
                        <a 
                            ...
                            data-user-id="<?= get_session('user')->id ?>"><i class="fa fa-reply"></i> Répondre</a>
                        ...
                        <?php
                            if (!empty($topic->attachments)) :
                                ...
                                foreach ($attachments as $attachment) :
                                    $file_extension = explode('.', $attachment);
                        ?>
                        
                            <div class="col p-2">

                        <?php if (in_array($file_extension[1], $files_extensions)) : ?>

                                <a href="<?= absolute_url('/public/uploads/'. $topic->slug . '/' . $attachment) ?>">
                                    <img 
                                        src="<?= absolute_url('/public/uploads/'. $topic->slug . '/' . $attachment) ?>" 
                                        alt="Fichier joint" 
                                        class="img-fluid">
                                </a>
            ...
            <div class="col-lg-9">
                ...
                <div class="d-flex align-items-center justify-content-between mt-3">
                    ...
                    <div>
                        ...
                        <a 
                            href="#" 
                            class="btn btn-secondary mr-2 edit-comment" 
                            data-comment-id="<?= $comment->id ?>" 
                            data-comment-content="<?= $comment->content ?>"><i class="fa fa-edit"></i> Modifier</a>
                        ...
                        <a 
                            href="#" 
                            class="btn btn-success update-comment-score" 
                            data-user-id="<?= $comment->user_id ?>"
                            data-comment-id="<?= $comment->id ?>">Voter</a>
                        ...
                        <a 
                            ...
                            class="btn btn-success update-comment-score" 
                            data-user-id="<?= $comment->user_id ?>"
                            data-comment-id="<?= $comment->id ?>">Annuler le vote</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if (in_array($file_extension[1], $files_extensions)) : ?>
                                <a href="<?= absolute_url('/public/uploads/'. $topic->slug .'/'. $comment->user_id .'/'. $attachment) ?>">
                                    <img 
                                        src="<?= absolute_url('/public/uploads/'. $topic->slug .'/'. $comment->user_id .'/'. $attachment) ?>" 
                                        alt="Fichier joint" 
                                        class="img-fluid">
                                </a>
                        ...
                        <?php else : ?>
                                ...
                                <a href="<?= absolute_url('/public/'. $topic->slug .'/'. $comment->user_id .'/'. $attachment) ?>">
                                    <?= $attachment ?>
                                </a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form 
                    ...
                    data-user-id="" 
                    data-comment-id="" 
                    action="<?= absolute_url('/comment/add/'. $topic->slug) ?>" 
