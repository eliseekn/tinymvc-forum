...
<head>
    ...
    <meta name="description" content="Vous n'êtes pas autorisé à accéder à cette page">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" href="<?= absolute_url('/public/assets/css/main.css') ?>">
    <title>Accès non autorisé | eduForum</title>
</head>
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center mt-5">
        <div class="card shadow d-flex flex-column align-items-center p-5 mt-5 bg-dark">
            <i class="fa fa-minus-circle fa-5x text-white"></i>
            <h1 class="display-4 pt-3 text-center text-white">Erreur 403</h1>
